...
q({id:'v9-work-task',cat:'Rendimiento',title:'Tareas frecuentes',skill:null,kind:'context',text:'¿Qué tipo de tarea ocupa más tiempo en una semana normal?',options:[cap('Organizar, coordinar o hacer seguimiento','responsibility','projects'),cap('Vender, negociar o hacer seguimiento comercial','responsibility','sales'),cap('Atender personas o resolver pedidos/problemas','responsibility','clients'),cap('Trabajar con números, costos, caja o registros','responsibility','finance'),cap('Analizar información y tomar decisiones','responsibility','analysis'),cap('Producir, operar o resolver tareas técnicas','responsibility','technical'),cap('Crear, diseñar, escribir o comunicar','responsibility','creative'),cap('Estudiar, practicar o preparar evaluaciones','responsibility','study')]}),
